...
process run_initial_read_processing {
  ...
  -G "negative=${params.primer.negative.R2_leading};max_error_rate=0.025;rightmost" \
  -G "positive=${params.primer.positive.R2_leading};max_error_rate=0.025;rightmost" \
  --discard-untrimmed \
